...
export const timelineData = [
  {
    ...
    description: "Grandparents Maria and Carlos Etete started their journey together in a small village, building the foundation of our family legacy.",
    image: "/images/timeline/foundation.jpg",
    category: "foundation",
    members: ["grandpa-maria", "grandpa-carlos"],
    location: "Seville, Spain",
    significance: "The beginning of the EteteFamily legacy",
    icon: "🌱",
  ...
  },
  {
    ...
    description: "The family expanded with the birth of their children, bringing new energy and dreams to the Etete family tree.",
  ...
  },
  {
    ...
    description: "The Etete family business flourished, becoming a cornerstone of our community and providing for generations to come.",
  ...
  },
  {
    ...
    description: "Family members began traveling and settling around the world, creating an international EteteFamily network.",
  ...
  },
  {
    ...
    year: 2023,
    title: "Modern Legacy",
    description: "The EteteFamily continues to grow, with new generations carrying forward our traditions while creating their own paths.",
